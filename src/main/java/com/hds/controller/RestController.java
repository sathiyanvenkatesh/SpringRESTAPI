...
import com.hds.model.Status;
import com.hds.services.DataServices;
...
public class RestController {
	...
	Employee getEmployee(@PathVariable("id") long id) {
		...
		try {
			employee = dataServices.getEmployeeById(id);
	...
	List<Employee> getEmployee() {
		...
		try {
			employeeList = dataServices.getEmployees();
	...
	Status deleteEmployee(@PathVariable("id") long id) {
		...
		try {
			dataServices.deleteEmployee(id);
